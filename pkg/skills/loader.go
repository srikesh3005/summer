...
type SkillsLoader struct {
	...
	globalSkills    string // 全局 skills (~/.summer/skills)
...
func NewSkillsLoader(workspace string, globalSkills string, builtinSkills string) *SkillsLoader {
	return &SkillsLoader{
		...
		globalSkills:    globalSkills, // ~/.summer/skills
...
func (sl *SkillsLoader) ListSkills() []SkillInfo {
	...
	// 全局 skills (~/.summer/skills) - 被 workspace skills 覆盖
	if sl.globalSkills != "" {
...
func (sl *SkillsLoader) LoadSkill(name string) (string, bool) {
	...
	// 2. 其次从全局 skills 加载 (~/.summer/skills)
	if sl.globalSkills != "" {
